    ...
    private void initView() {
        ...
        mCaptureLayout.setCaptureLisenter(new CaptureListener() {
            ...
            public void recordStart() {
                ...
                mSwitchCamera.setVisibility(INVISIBLE);
                mFlashLamp.setVisibility(INVISIBLE);
                String model = Camera.Parameters.FLASH_MODE_OFF;
                switch (type_flash) {
                    case TYPE_FLASH_AUTO:
                        model = Camera.Parameters.FLASH_MODE_AUTO;
                        break;
                    case TYPE_FLASH_ON:
                        model = Camera.Parameters.FLASH_MODE_TORCH;
                        break;
                    case TYPE_FLASH_OFF:
                        model = Camera.Parameters.FLASH_MODE_OFF;
                        break;
                }

                machine.record(model,mVideoView.getHolder().getSurface(), screenProp);
            }
